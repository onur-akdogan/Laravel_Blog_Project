...
@section('content')
    ...
    <h6 class="heading-small text-muted mb-4">Kullanıcı Düzenle</h6>
@foreach($kullanici as $gelenKullanici)
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{$gelenKullanici->name}}"
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="email" name="email" value="{{$gelenKullanici->email}}"
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password" value="{{$gelenKullanici->password}}"
