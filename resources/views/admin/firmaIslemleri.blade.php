...
@section('content')
    ...
    <h6 class="heading-small text-muted mb-4">Yeni Firma Ekle</h6>
        ...
        <form method="POST" action="">
            ...
            <div class="pl-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label" for="fotoName">Başlık</label>
                            <input type="text" id="fotoName" name="fotoName"
